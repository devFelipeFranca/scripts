...
sudo apt install -y build-essential git wget curl tar gzip tasksel nano unrar p7zip-full p7zip-rar net-tools nmap openssh-server stress-ng f2fs-tools htop lynx vim
